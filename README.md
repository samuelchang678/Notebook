...
3. I am having some issues with the markdown component.  I am seeing my nested list are not render correctly in the preview pane. They appear as plain number with any spacing. My headings also has no styling and look all the same. When i inspect the DOM, i notice that the some css are applied, I am using tailwind version 4. How do I fix this and why is this happening. 